...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUserValueRating = (TextView) findViewById(R.id.writtenCountId);
        mUserValueCodeLine = (TextView) findViewById(R.id.ratingCountId);
        mUserValueProjects = (TextView) findViewById(R.id.projectsCount);
